...
1.- Modyfy *Gemfile*
<pre><code class="html">gem 'omniauth'</code></pre>

2.- <pre><code class="html">bundle install</code></pre>
...
<pre><code class="html">rails g scaffold authentication user_id:integer provider:string uid:string</code></pre>
...
<pre><code class="html">rails g controller registrations</code></pre>

...
<pre>rails g scaffold authentication user_id:integer provider:string uid:string</pre>
...
<pre>match '/auth/:provider/callback' => 'authentications#create'</pre>
...
<pre>rails g controller registrations</pre>
